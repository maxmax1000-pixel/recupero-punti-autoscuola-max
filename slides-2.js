    ...
    },
{
      ...
      html:()=>`<div class="case-template">
        ...
        <div class="case-solution ${state.revealed?'visible':''}" id="reveal">
          <div class="case-solution-label">Risposta esatta</div>
          <div class="case-solution-answer">Semaforo per corsie reversibili.</div>
          <p class="case-solution-explain">Queste lanterne regolano l’utilizzo di corsie il cui senso di marcia può essere modificato in funzione delle esigenze del traffico.</p>
          <div class="case-rule"><span class="case-rule-chip">X ROSSA</span><span class="case-rule-arrow">·</span><span class="case-rule-chip">FRECCIA GIALLA</span><span class="case-rule-arrow">·</span><span class="case-rule-chip">FRECCIA VERDE</span></div>
