(() => {
  ...
  function fitTeacherSlide() {
    ...
    frame = requestAnimationFrame(() => {
      ...
      // La cornice docente usa tutta l'altezza disponibile del palco.
      ...
      // Se serve ridurre, allarghiamo il layout non trasformato così la slide
      // continua a sfruttare la larghezza disponibile e il testo va meno a capo.
      ...
      // Margine di sicurezza per differenze di font e arrotondamenti tra browser.
      ...
      inner.dataset.fitEngine = 'teacher-structural-v1';
    });
  }
